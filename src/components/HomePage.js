...
class HomePage extends React.Component {
  ...
  bg1Change() {
    let bg1Top = document.getElementById("motivationBox").offsetTop - 150;

    if (Math.abs(bg1Top - this.state.bg1Top) >= 20) {
      let bg1Height =
        document.getElementById("motivationBox").offsetHeight + 300;
      this.setState(() => {
        return {
          bg1Top,
          bg1Height,
            ...
            {this.state.cLetters.length > 0 && (
              <div>
                ...
                >
                  ...
                  >
                    Ingeniero en <span>Sonido</span> de profesión, elegí abrirme
                    paso entre editores de texto y bugs infinitos debido a mi
                    afinidad natural con el área y la extensión del campo
                    laboral.{" "}
                  </p>
                </div>
